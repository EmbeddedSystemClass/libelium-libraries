...
<title>SD 04: Read file | Libelium</title>
...
<meta name="keywords" content="file,general,read,sd,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/sd-04-read-file/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/sd-04-read-file/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'SD 04: Read file']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> SD 04: Read file</h3>

    <p>This example shows how to turn on the SD card. Append data at the end of the SD file and then how to read it.</p>
...
<br />
-----------------------------<br />
1 - Use of SD.cat function<br />
-----------------------------<br />
Read file in bytes (offset:0; scope:10):<br />
aaaaaaaaaa<br />
-----------------------------<br />
Read file in bytes (offset:25; scope:10):<br />
aaaaa<br />
bbbb<br />
-----------------------------<br />
Read file in bytes (offset:0; scope:1000) [256 bytes max]:<br />
aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa<br />
bbbbbbbbbbbbbbbbbbbbbbbbbbbbbb<br />
cccccccccccccccccccccccccccccc<br />
dddddddddddddddddddddddddddddd<br />
...
<br />
-----------------------------<br />
2 - Use of SD.catBin function<br />
-----------------------------<br />
Read binary data (offset:0; scope:10):<br />
61616161616161616161<br />
-----------------------------<br />
Read binary data (offset:25; scope:10):<br />
61616161610A62626262<br />
-----------------------------<br />
Read binary data (offset:0; scope:50):<br />
6161616161616161616161616161616161616161616161616161616161610A62626262626262626262626262626262626262<br />
-----------------------------<br />
<br />
<br />
-----------------------------<br />
3 - Use of SD.catln function<br />
-----------------------------<br />
Read file lines (offset:0; scope:1):<br />
aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa<br />
<br />
-----------------------------<br />
Read file lines (offset:1; scope:1):<br />
bbbbbbbbbbbbbbbbbbbbbbbbbbbbbb<br />
<br />
-----------------------------<br />
Read file lines (offset:2; scope:1):<br />
cccccccccccccccccccccccccccccc<br />
<br />
-----------------------------<br />
Read file lines (offset:0; scope:5):<br />
aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa<br />
bbbbbbbbbbbbbbbbbbbbbbbbbbbbbb<br />
cccccccccccccccccccccccccccccc<br />
dddddddddddddddddddddddddddddd<br />
...
<br />
-----------------------------<br />
Read file lines (offset:0; scope:25) [256 bytes max]:<br />
aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa<br />
bbbbbbbbbbbbbbbbbbbbbbbbbbbbbb<br />
cccccccccccccccccccccccccccccc<br />
dddddddddddddddddddddddddddddd<br />
...
*****************************<br />
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=SD 04: Read file&p[summary]=This+example+shows+how+to+turn+on+the+SD+card.+Append+data+at+the+end+of+the+SD+file+and+then+how+to+read+it.&p[url]=http://www.libelium.com/development/waspmote/examples/sd-04-read-file/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=SD+04%3A+Read+file&url=http://www.libelium.com/development/waspmote/examples/sd-04-read-file/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/sd-04-read-file/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/sd-04-read-file/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
