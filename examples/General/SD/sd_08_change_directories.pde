...
<title>SD 08: Change directories | Libelium</title>
...
<meta name="keywords" content="general,path,sd,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/sd-08-change-directories/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/sd-08-change-directories/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'SD 08: Change directories']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> SD 08: Change directories</h3>

    <p>This example shows how to turn on the SD card. Move from one to another directory in order to manage files directly in each folder instead of using complete paths.</p>
    <div class="box materials"><h4>Required Materials</h4><p>1 x Waspmote<br />
1 x Battery<br />
1 x SD card<br />
1 x MiniUSB wire</p></div>
    <div class="box note"><h4>Notes</h4><p>- Remember that only 8.3 SHORT FILE NAME are valid for files and directories<br />
- Make sure Waspmote is switched off before inserting or removing the SD card. Otherwise, the SD card could be damaged.<br />
- Waspmote must not be switched off or reseted while there are ongoing read or write operations in the SD card. Otherwise, the SD card could be damaged and data could be lost. If you suspect that there may be some ongoing SD operations, wait a while until they are completed.<br />
...
SD_08 example<br />
Delete whole directory path<br />
Created directory system:/FOLD1/FOLD2/FOLD3<br />
<br />
inside /FOLD1/FOLD2/FOLD3:<br />
FILE3 created<br />
-----------------------------<br />
<br />
list /FOLD1/FOLD2/FOLD3 contents:<br />
-----------------------------<br />
FILE3          2014-06-02 18:46:22 0<br />
-----------------------------<br />
<br />
inside /FOLD1/FOLD2:<br />
FILE2 created<br />
<br />
-----------------------------<br />
list /FOLD1/FOLD2 contents:<br />
-----------------------------<br />
FOLD3/         2014-06-02 18:46:22<br />
FILE2          2014-06-02 18:46:26 0<br />
-----------------------------<br />
<br />
inside /FOLD1<br />
FILE1 created<br />
<br />
-----------------------------<br />
list /FOLD1 contents:<br />
-----------------------------<br />
FOLD2/         2014-06-02 18:46:22<br />
FILE1          2014-06-02 18:46:28 0<br />
-----------------------------<br />
<br />
inside ROOT directory:<br />
###############################<br />
ACC_FILE.TXT   2013-06-19 14:12:34 25591<br />
PWR1.TXT       2010-10-06 14:00:54 926<br />
INT_FILE.TXT   2010-02-08 14:10:56 585<br />
FILE1.TXT      2014-06-02 18:32:38 0<br />
FILE2.TXT      2014-06-02 18:35:36 5<br />
FILE3.TXT      2014-06-02 18:38:10 52<br />
FILE4.TXT      2014-06-02 18:39:32 279<br />
FOLDER1/       2014-06-02 18:44:36<br />
  FOLDER2/       2014-06-02 18:44:36<br />
    FOLDER3/       2014-06-02 18:44:36<br />
      FILE3          2014-06-02 18:44:38 0<br />
      LOG            2014-06-02 18:45:16 2454<br />
    FILE2          2014-06-02 18:44:38 0<br />
  FILE1          2014-06-02 18:44:36 0<br />
FOLD1/         2014-06-02 18:46:22<br />
  FOLD2/         2014-06-02 18:46:22<br />
    FOLD3/         2014-06-02 18:46:22<br />
      FILE3          2014-06-02 18:46:22 0<br />
    FILE2          2014-06-02 18:46:26 0<br />
  FILE1          2014-06-02 18:46:28 0<br />
FILE.TXT       2010-10-06 19:35:12 2300<br />
FILEYURI.TXT   2010-02-08 14:48:02 2300<br />
DEVICES.TXT    2012-07-17 17:41:20 211<br />
FILETEST.TXT   2010-10-06 19:38:22 253<br />
BT_FILE.TXT    2010-11-23 12:00:56 222<br />
DATA/          2012-07-17 19:09:50<br />
  FILE3          2014-06-02 18:44:38 0<br />
  LOG            2014-06-02 18:45:16 2454<br />
FILE9.TXT      2012-07-17 19:27:08 185<br />
###############################<br />
</p></div>
    <div class="box seealso"><h4>See also</h4><ul><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide-v12/">Waspmote Technical Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/sd-card-programming-guide-v12/">SD Card Programming Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide/"> Waspmote Technical Guide</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/sd-card-programming-guide/">SD Card Programming Guide</a></li></ul></div>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=SD 08: Change directories&p[summary]=This+example+shows+how+to+turn+on+the+SD+card.+Move+from+one+to+another+directory+in+order+to+manage+files+directly+in+each+folder+instead+of+using+complete+paths.&p[url]=http://www.libelium.com/development/waspmote/examples/sd-08-change-directories/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=SD+08%3A+Change+directories&url=http://www.libelium.com/development/waspmote/examples/sd-08-change-directories/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/sd-08-change-directories/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/sd-08-change-directories/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
