...
<title>SD 07: Datalogger | Libelium</title>
...
<meta name="keywords" content="datalogger,frame,general,sd,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/sd-07-datalogger/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/sd-07-datalogger/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'SD 07: Datalogger']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> SD 07: Datalogger</h3>

    <p>This example shows how to store formatted frames in SD file using the Data Frame class. Besides, it shows how to get these frames from the file and get them ready to be sent.</p>
...
- Waspmote can not be switched off or reseted while there are ongoing read or write operations in the SD card. Otherwise, the SD card could be damaged and data could be lost. If you suspect that there may be some ongoing SD operations, wait a while until they are completed.<br />
...
Length: 78<br />
Frame Type:  134<br />
frame (HEX): 3C3D3E8603233444334337303633443933373432463423576173706D6F74655F50726F2330235354523A64617461206672616D65234241543A313030234143433A2D32393B2D33373B3130303123<br />
frame (STR): <=>�#4D3C7063D93742F4#Waspmote_Pro#0#STR:data frame#BAT:100#ACC:-29;-37;1001#<br />
===============================<br />
Frame to be stored:3C3D3E8603233444334337303633443933373432463423576173706D6F74655F50726F2330235354523A64617461206672616D65234241543A313030234143433A2D32393B2D33373B3130303123<br />
Frame appended to file<br />
Get previously stored frame:<=>�#4D3C7063D93742F4#Waspmote_Pro#0#STR:data frame#BAT:100#ACC:-29;-37;1001#</p></div>
    <div class="box seealso"><h4>See also</h4><ul><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide-v12/">Waspmote Technical Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/data-frame-guide-v12/">Data Frame Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/sd-card-programming-guide-v12/">SD Card Programming Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide/"> Waspmote Technical Guide</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/data-frame-guide/">Data Frame Guide</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/sd-card-programming-guide/">SD Card Programming Guide</a></li></ul></div>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=SD 07: Datalogger&p[summary]=This+example+shows+how+to+store+formatted+frames+in+SD+file+using+the+Data+Frame+class.+Besides%2C+it+shows+how+to+get+these+frames+from+the+file+and+get+them+ready+to+be+sent.&p[url]=http://www.libelium.com/development/waspmote/examples/sd-07-datalogger/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=SD+07%3A+Datalogger&url=http://www.libelium.com/development/waspmote/examples/sd-07-datalogger/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/sd-07-datalogger/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/sd-07-datalogger/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
