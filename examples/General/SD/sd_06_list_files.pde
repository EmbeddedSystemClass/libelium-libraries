...
<title>SD 06: List files | Libelium</title>
...
<meta name="keywords" content="file,general,path,sd,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/sd-06-list-files/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/sd-06-list-files/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'SD 06: List files']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> SD 06: List files</h3>

    <p>This example shows how to turn on the SD card. Firstly, delete all folder and all contained files. Secondly, create all directories specified in path. Finally, create files inside each subfolder and show the created directories and files. The rest of the program shows how to list the directories in several ways.</p>
...
SD_06 example<br />
deleted folders and all contained files<br />
/FOLDER1/FOLDER2/FOLDER3/ created<br />
/FOLDER1/file1 created<br />
/FOLDER1/FOLDER2/file2 created<br />
/FOLDER1/FOLDER2/FOLDER3/file3 created<br />
<br />
---------------------------<br />
list (file size details by default):<br />
---------------------------<br />
FOLDER1/      <br />
---------------------------<br />
<br />
...
<br />
---------------------------<br />
list recursively showing file size:<br />
---------------------------<br />
FOLDER1/      <br />
  FOLDER2/      <br />
    FOLDER3/      <br />
...
<br />
---------------------------<br />
list recursively showing date and file size:<br />
---------------------------<br />
FOLDER1/      2000-01-01 01:00:00<br />
  FOLDER2/      2000-01-01 01:00:00<br />
    FOLDER3/      2000-01-01 01:00:00<br />
      FILE3         2000-01-01 01:00:00 0<br />
    FILE2         2000-01-01 01:00:00 0<br />
  FILE1         2000-01-01 01:00:00 0<br />
---------------------------<br />
</p></div>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=SD 06: List files&p[summary]=This+example+shows+how+to+turn+on+the+SD+card.+Firstly%2C+delete+all+folder+and+all+contained+files.+Secondly%2C+create+all+directories+specified+in+path.+Finally%2C+create+files+inside+each+subfolder+and+show+the+created+directories+and+files.+The+rest+of+the+program+shows+how+to+list+the+directories+in+several+ways.&p[url]=http://www.libelium.com/development/waspmote/examples/sd-06-list-files/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=SD+06%3A+List+files&url=http://www.libelium.com/development/waspmote/examples/sd-06-list-files/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/sd-06-list-files/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/sd-06-list-files/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
