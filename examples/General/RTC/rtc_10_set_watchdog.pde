...
<title>RTC 10: Set watchdog | Libelium</title>
...
<meta name="keywords" content="rtc,rtc_alarm,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/rtc-10-set-watchdog/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/rtc-10-set-watchdog/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'RTC 10: Set watchdog']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> RTC 10: Set watchdog</h3>

    <p>This example shows how to setup the RTC watchdog reset through the Alarm2 of the RTC. The RTC.setWatchdog() function permits to configure device resets in order to avoid </p>
    <div class="box materials"><h4>Required Materials</h4><p>1 x Waspmote<br />
1 x MiniUSB wire<br />
1 x Battery</p></div>
    <div class="box note"><h4>Notes</h4><p>This example can be executed in Waspmote v15</p></div>
...
RTC time:<br />
------------------------------------<br />
Tue, 09/10/20, 17:36:30<br />
------------------------------------<br />
<br />
Watchdog settings:<br />
----------------------------------------------------<br />
Alarm Mode matches [Date:Hours:Minutes ] --> [20:17:37]<br />
----------------------------------------------------<br />
<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:30<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:31<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:32<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:33<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:34<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:35<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:36<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:37<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:38<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:39<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:40<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:41<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:42<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:43<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:44<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:45<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:46<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:47<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:48<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:49<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:50<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:51<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:52<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:53<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:54<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:55<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:56<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:57<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:58<br />
Inside infinite loop. Time: Tue, 09/10/20, 17:36:59<br />
H#<br />
*************************************<br />
RTC_10 example<br />
*************************************<br />
...
RTC time:<br />
------------------------------------<br />
Tue, 09/10/20, 17:37:02<br />
------------------------------------<br />
...</p></div>
    <div class="box seealso"><h4>See also</h4><ul><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide/"> Waspmote Technical Guide</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/rtc-programming-guide/">RTC Programming Guide</a></li></ul></div>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=RTC 10: Set watchdog&p[summary]=This+example+shows+how+to+setup+the+RTC+watchdog+reset+through+the+Alarm2+of+the+RTC.+The+RTC.setWatchdog%28%29+function+permits+to+configure+device+resets+in+order+to+avoid+&p[url]=http://www.libelium.com/development/waspmote/examples/rtc-10-set-watchdog/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=RTC+10%3A+Set+watchdog&url=http://www.libelium.com/development/waspmote/examples/rtc-10-set-watchdog/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/rtc-10-set-watchdog/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/rtc-10-set-watchdog/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
