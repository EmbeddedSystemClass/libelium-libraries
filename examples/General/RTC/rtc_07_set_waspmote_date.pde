...
<title>RTC 07: Set Waspmote Date | Libelium</title>
...
<meta name="keywords" content="rtc,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/rtc-07-set-waspmote-date/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/rtc-07-set-waspmote-date/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'RTC 07: Set Waspmote Date']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> RTC 07: Set Waspmote Date</h3>

    <p>This example permits to set Time and Date in Waspmote's RTC very easily via USB port. There is an interface which asks the user to introduce the Date and Time as specified without any need to change this code.</p>
    <div class="box materials"><h4>Required Materials</h4><p>1 x Waspmote<br />
1 x MiniUSB wire<br />
1 x Battery</p></div>
    <div class="box note"><h4>Notes</h4><p>- Remember not to remove the Battery from Waspmote so as not to lose the Time and Date set. The RTC remains powered through the battery. So, in the case it is removed, the RTC registers will be cleared.<br />
...
RTC_7 example<br />
-------------------------------------<br />
Set RTC Date and Time via USB port<br />
-------------------------------------<br />
Insert year [yy]:13<br />
Insert month [mm]:9<br />
Insert day [dd]:11<br />
Insert Hour [HH]:12<br />
Insert minute [MM]:54<br />
Insert second [SS]:34<br />
13:09:11:04:12:54:34<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:34<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:35<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:36<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:37<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:38<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:39<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:41<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:42<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:43<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:44<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:45<br />
Time [Day of week, YY/MM/DD, hh:mm:ss]: Wed, 13/09/11, 12:54:46<br />
...</p></div>
    <div class="box seealso"><h4>See also</h4><ul><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide-v12/">Waspmote Technical Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/rtc-programming-guide-v12/">RTC Programming Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide/"> Waspmote Technical Guide</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/rtc-programming-guide/">RTC Programming Guide</a></li></ul></div>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=RTC 07: Set Waspmote Date&p[summary]=This+example+permits+to+set+Time+and+Date+in+Waspmote%27s+RTC+very+easily+via+USB+port.+There+is+an+interface+which+asks+the+user+to+introduce+the+Date+and+Time+as+specified+without+any+need+to+change+this+code.&p[url]=http://www.libelium.com/development/waspmote/examples/rtc-07-set-waspmote-date/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=RTC+07%3A+Set+Waspmote+Date&url=http://www.libelium.com/development/waspmote/examples/rtc-07-set-waspmote-date/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/rtc-07-set-waspmote-date/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/rtc-07-set-waspmote-date/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
