...
void setup()
{
  ...
  if (radio_type == 0)
  {
    ...
    if (answer == 1)
    {
      ...
      USB.println(F("--> Hardware serie: LoRaWAN 868"));
      if (dev_eui_answer == 1)
      {
    ...
    {
      USB.println(F("LoRaWAN module is plugged on socket 0:"));
      USB.println(F("--> Hardware serie: LoRaWAN 900"));
      if (dev_eui_answer == 1)
      {
        USB.print(F("--> Device EUI: "));
        USB.print(uart._buffer, uart._length);
  ...
  if (radio_type == 0)
  {
    ...
    if (answer == 1)
    {
      ...
      USB.println(F("--> Hardware serie: Sigfox 868"));
    ...
    {
      USB.println(F("SIGFOX module is plugged on socket 0:"));
      USB.println(F("--> Hardware serie: Sigfox 900"));
      USB.print(F("--> Serial Number: "));
      USB.println(sigfox_id);
      radio_type = 8;
    }
...
<title>Waspmote factory default | Libelium</title>
...
<meta name="keywords" content="general,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/waspmote-pro-test-code/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/waspmote-pro-test-code/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'Waspmote factory default']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> Waspmote factory default</h3>

    <p>This code sends basic parameters through the corresponding radio module.</p>
    <div class="box materials"><h4>Required Materials</h4><p>1 x Waspmote<br />
1 x Battery<br />
1 x miniUSB wire<br />
1 x radio module (optional)<br />
1 x gateway + radio module (optional)</p></div>
    <div class="box note"><h4>Notes</h4><p>- This is the default factory code for Waspmote v15. So any Waspmote or Plug&Sense! device is received like this.<br />
- The code is valid for all XBee modules communication protocols. <br />
- Some basic parameters are read by this code, like MAC address of radio module, accelerometer axes values and battery level.<br />
- All this data is gathered into a standard Frame packet.<br />
- When an XBee is connected the code will output the information both via XBee and USB.<br />
- For other communication protocols this code is still valid, but the data is printed via USB only.<br />
- By default, SOCKET0 will be used. If no XBee is connected on SOCKET0, then the information will be printed by USB.<br />
- This code configures automatically an XBee module with default Waspmote parameters (BD7 [baudrate] and AP2 [AP mode])<br />
- This example can be executed in Waspmote v15. Only Waspmote v15 radio modules are supported.</p></div>
    <div class="box code"><h4>Code</h4><pre><code class="cpp">/*
    ------ Waspmote factory default code ------
...
Starting Waspmote factory default program<br />
Global variable '_serial_id':3A867063D9374284<br />
Waspmote serial ID: 3A867063D9374284<br />
SD OK<br />
<br />
No radio module detected<br />
<br />
===============================<br />
===============================<br />
...
Length: 55<br />
Frame Type:  134<br />
frame (HEX): 3C3D3E86022333413836373036334439333734323834236E6F64655F69642330234143433A31373B36323B31303338234241543A383023<br />
frame (STR): <=>�#3A867063D9374284#node_id#0#ACC:17;62;1038#BAT:80#<br />
===============================<br />
the frame above is printed just by USB (no radio module detected)<br />
enter deep sleep<br />
</p></div>
    <div class="box seealso"><h4>See also</h4><ul><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide/"> Waspmote Technical Guide</a></li></ul></div>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=Waspmote factory default&p[summary]=This+code+sends+basic+parameters+through+the+corresponding+radio+module.&p[url]=http://www.libelium.com/development/waspmote/examples/waspmote-pro-test-code/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=Waspmote+factory+default&url=http://www.libelium.com/development/waspmote/examples/waspmote-pro-test-code/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/waspmote-pro-test-code/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/waspmote-pro-test-code/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
