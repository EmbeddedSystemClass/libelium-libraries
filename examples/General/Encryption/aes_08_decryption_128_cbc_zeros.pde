...
<title>AES 08: AES 128, CBC, PKCS with Frame | Libelium</title>
...
<meta name="keywords" content="aes,decryption,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/aes-08-decryption-128-cbc-zeros/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/aes-08-decryption-128-cbc-zeros/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'AES 08: AES 128, CBC, PKCS with Frame']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> AES 08: AES 128, CBC, PKCS with Frame</h3>

    <p>This example shows how to encrypt a binary message:
 - AES algorithm
 - 128-bit key size
 - PKCS Padding
 - CBC Cipher Mode </p>
...
Length: 70<br />
Frame Type:  128<br />
frame (HEX): 3C3D3E800323333837323634353339236E6F64655F3030312330235354523A746869735F69735F615F6D657373616765234241543A363423494E5F54454D503A32302E373523<br />
frame (STR): <=>#387264539#node_001#0#STR:this_is_a_message#BAT:64#IN_TEMP:20.75#<br />
===============================<br />
<br />
2. Encrypting Frame<br />
AES Encrypted message: "5EE419EF3F35475204A7B99FC883B1C755F22DE3F5CEDF0FA4A55F15012E89940B4EC4510E34E63B5F5C2F458C629C9DAC1EF9AEEB1ECC69FF49BEB89B0C021F4190C51A48956ECD961409E2BA2275CA"<br />
AES Encrypted length:80<br />
<br />
***********************<br />
1. Creating an ASCII frame<br />
===============================<br />
...
Length: 70<br />
Frame Type:  128<br />
frame (HEX): 3C3D3E800323333837323634353339236E6F64655F3030312331235354523A746869735F69735F615F6D657373616765234241543A363523494E5F54454D503A32302E373523<br />
frame (STR): <=>#387264539#node_001#1#STR:this_is_a_message#BAT:65#IN_TEMP:20.75#<br />
===============================<br />
<br />
2. Encrypting Frame<br />
AES Encrypted message: "5EE419EF3F35475204A7B99FC883B1C77B83C5B263862424E29CDBF75262BA1CF653E7277AC1D00189DDF025B7B00953DCE640F283B7E87C0ED9E18AB56772CCF25610CF90B6C9B05D60E736E321FBA0"<br />
AES Encrypted length:80<br />
<br />
...</p></div>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=AES 08: AES 128, CBC, PKCS with Frame&p[summary]=This+example+shows+how+to+encrypt+a+binary+message%3A%0D%0A+-+AES+algorithm%0D%0A+-+128-bit+key+size%0D%0A+-+PKCS+Padding%0D%0A+-+CBC+Cipher+Mode+&p[url]=http://www.libelium.com/development/waspmote/examples/aes-08-decryption-128-cbc-zeros/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=AES+08%3A+AES+128%2C+CBC%2C+PKCS+with+Frame&url=http://www.libelium.com/development/waspmote/examples/aes-08-decryption-128-cbc-zeros/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/aes-08-decryption-128-cbc-zeros/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/aes-08-decryption-128-cbc-zeros/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
