...
<title>AES 07: AES 128, EBC, ZEROS with Frame | Libelium</title>
...
<meta name="keywords" content="aes,encryption,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/aes-07-encryption-128-cbc-zeros/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/aes-07-encryption-128-cbc-zeros/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'AES 07: AES 128, EBC, ZEROS with Frame']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> AES 07: AES 128, EBC, ZEROS with Frame</h3>

    <p>This example shows how to encrypt a Waspmote Frame to be sent to Meshlium:
 - AES algorithm
 - 128-bit key size
 - ZEROS Padding
 - ECB Cipher Mode  </p>
...
Maximum Frame Size:80<br />
===============================<br />
Current BINARY Frame:<br />
Length: 33<br />
Frame Type:  0<br />
frame (HEX): 3C3D3E001CC00E15176E6F64655F303031230034193E0000CC413F2000CCFF0B04<br />
frame (STR): <=> Ànode_001#4>ÌA?Ìÿ<br />
===============================<br />
<br />
...
Length: 66<br />
Frame Type:  97<br />
frame (HEX): 3C3D3E613DC00E15176E6F64655F3030312390DB2A02110CDB28F8ECBCCF599F086634A7D0403682E447287C29AD0827838C7A48B1090D5A337D7638215D732EF3A7<br />
frame (STR): <=>a=Ànode_001#Û*Û(øì¼ÏYf4§Ð@6äG(|)­'zH±	Z3}v8!]s.ó§<br />
===============================<br />
<br />
sending ok<br />
*****************************<br />
<br />
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=AES 07: AES 128, EBC, ZEROS with Frame&p[summary]=This+example+shows+how+to+encrypt+a+Waspmote+Frame+to+be+sent+to+Meshlium%3A%0D%0A+-+AES+algorithm%0D%0A+-+128-bit+key+size%0D%0A+-+ZEROS+Padding%0D%0A+-+ECB+Cipher+Mode++&p[url]=http://www.libelium.com/development/waspmote/examples/aes-07-encryption-128-cbc-zeros/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=AES+07%3A+AES+128%2C+EBC%2C+ZEROS+with+Frame&url=http://www.libelium.com/development/waspmote/examples/aes-07-encryption-128-cbc-zeros/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/aes-07-encryption-128-cbc-zeros/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/aes-07-encryption-128-cbc-zeros/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
