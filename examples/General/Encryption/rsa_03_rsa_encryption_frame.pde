...
<title>RSA 03: RSA Encryption Frame | Libelium</title>
...
<meta name="keywords" content="encryption,rsa,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/rsa-03-rsa-encryption-frame/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/rsa-03-rsa-encryption-frame/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'RSA 03: RSA Encryption Frame']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> RSA 03: RSA Encryption Frame</h3>

    <p>This example calculates an encrypted message using the RSA algorithm. For encryption, only the public key is needed. The public key is determined by the modulus and the exponent. The "public key" is (n,e). Where 'n' is the modulus and 'e' is the exponent of the public key</p>
    <div class="box materials"><h4>Required Materials</h4><p>1 x Waspmote<br />
1 x Battery</p></div>
    <div class="box note"><h4>Notes</h4><p>- The battery has to be connected.<br />
...
Example RSA_03<br />
<br />
public_exponent:00010001<br />
<br />
public_modulus:<br />
7ebd3e97454cc46ebcf758a5b0b1ddfc<br />
4775878048968cf3b2aaa0e34b8b0553<br />
15005c21a4e31404ebe82485ee114918<br />
8a5b96605c3f4437ef7deeff30a5eaa4<br />
af944c4405a1c3ac1f0d54453194f212<br />
ea50d6c04aee07b1c8c9a37661ad9126<br />
604f754f7270503f7b61fa7b72367cac<br />
7c871203caa31d77aa0616571ecf388b<br />
<br />
<br />
1. Creating an ASCII frame<br />
===============================<br />
Current ASCII Frame:<br />
Length: 62<br />
Frame Type:  134<br />
frame (HEX): 3C3D3E8602233444334337303633443933373432463423574153505F656E63727970746564233023535452A058426565206672616D65234241543A393823<br />
frame (STR): <=>�#4D3C7063D93742F4#WASP_encrypted#0#STR:XBee frame#BAT:98#<br />
===============================<br />
<br />
2. Encrypting Frame<br />
-------------------------<br />
Encrypted message:<br />
-------------------------<br />
322854D2FDDD9673787B1715FA50488A<br />
CF81F09436A9C4A72245CB49253FC337<br />
F0914E4202880D1036C1953E5C8A9593<br />
EDB35784A31DF9932846C3C8592D4300<br />
0E077C262CA2EBE58C284B187B870F81<br />
FAB9772E78FCB9160EB3C53EAFA774C6<br />
D106F8C36176CC396019420EEE1734DC<br />
584CFD0A901506DCDC20F538EC64DACD<br />
<br />
-------------------------<br />
-------------------------<br />
Encrypted length:256<br />
-------------------------<br />
</p></div>
    <div class="box seealso"><h4>See also</h4><ul><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide-v12/">Waspmote Technical Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/encryption-programming-guide-v12/">Encryption Programming Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide/"> Waspmote Technical Guide</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/encryption-programming-guide/">Encryption Programming Guide</a></li></ul></div>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=RSA 03: RSA Encryption Frame&p[summary]=This+example+calculates+an+encrypted+message+using+the+RSA+algorithm.+For+encryption%2C+only+the+public+key+is+needed.+The+public+key+is+determined+by+the+modulus+and+the+exponent.+The+%22public+key%22+is+%28n%2Ce%29.+Where+%27n%27+is+the+modulus+and+%27e%27+is+the+exponent+of+the+public+key&p[url]=http://www.libelium.com/development/waspmote/examples/rsa-03-rsa-encryption-frame/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=RSA+03%3A+RSA+Encryption+Frame&url=http://www.libelium.com/development/waspmote/examples/rsa-03-rsa-encryption-frame/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/rsa-03-rsa-encryption-frame/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/rsa-03-rsa-encryption-frame/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
