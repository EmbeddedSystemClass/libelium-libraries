...
<title>UT 07: Formatted strings | Libelium</title>
...
<link rel='stylesheet' id='libelium-css-css'  href='http://www.libelium.com/wp-content/themes/libelium/css/style.min.css?ver=1492420475' type='text/css' media='all' />
...
<meta name="keywords" content="waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/ut-07-formatted-strings/" />
...
<div id="wrapper">
	...
	<header>
		...
		<div class="header_nav">
			<div class="nav_top">
				<div class="languages" style="min-height:36px;">
									</div>
    ...
    <div>
        ...
        <div id="searchsubmit"></div>
            ...
            <li id="menu-item-4120"> <a
                    ...
                    href="http://www.libelium.com/products/meshlium/"><div class="submenu_meshlium"></div><span>Meshlium</span><p>Connect Sensor Networks to the Cloud</p
                    ...
                    ></a></li></br><li id="menu-item-23609"> <a
...
<script type="text/javascript">
$('#menu-item-4759').addClass('current_page_item');$('#searchsubmit').click(function() { $('#searchform').submit()});$('div.menu_bubble').detach().appendTo('header');var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $('ul.menu').width();var numero = 0;$('ul.menu li').each(function() {anchos[numero] = Array($(this).width(), $(this).attr('id')) ;ancho_total += $(this).width();numero++});for(var i =0; i <numero-1; i++) {ancho_final+= parseInt(((anchos[i][0]*total)/ancho_total)); $('#'+anchos[i][1]).css('width', (parseInt((anchos[i][0]*total)/ancho_total))+1)}$('#'+anchos[i-2][1]).css('width',total-ancho_final+10);$('#'+anchos[i][1]).css('width',total-ancho_final+3);$('header ul.menu li').css('opacity',1);if (navigator.appName != 'Microsoft Internet Explorer' || !(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent))) {$('div.nav_menu div ul li.menu-item').hover(function() {$('div.menu_bubble').hide();var marginleft = 157; var left = $(this).position()['left']+marginleft+($(this).width()/2)-18-$('div.nav_menu').position()['left']; $('div#desplegable_'+$(this).attr('id').match(/[\d]+$/)+' div#header_pincho').css('margin-left', left); $('div#desplegable_'+$(this).attr('id').match(/[\d]+$/)).show()}, function (e) { var id = $(this).attr('id').match(/[\d]+$/); var position = $('div#desplegable_'+id).position(); var width = $('div#desplegable_'+id).width(); var height = $('div#desplegable_'+id).height(); if (position != null && e.pageX >= position['left'] && e.pageX <= position['left']+width && e.pageY >= position['top']&& e.pageY <= position['top']+height) { $('div#desplegable_'+id).hover(function(){}, function() { $(this).hide() }); } else $('div#desplegable_'+id).hide()})}$('div.nav_menu div ul li.menu-item').click(function() {var id = $(this).attr('id').match(/[\d]+$/);if ($('div#desplegable_'+id).length) {if ($('div#desplegable_'+id).is(':visible')) $('div#desplegable_'+id).hide();else {var marginleft = ($('div#desplegable_'+$(this).attr('id').match(/[\d]+$/)).css('margin-left')== '0px')? 0 : 157;var left = $(this).position()['left']+marginleft+($(this).width()/2)-18-$('div.nav_menu').position()['left']; $('div#desplegable_'+$(this).attr('id').match(/[\d]+$/)+' div#header_pincho').css('margin-left', left); $('div#desplegable_'+$(this).attr('id').match(/[\d]+$/)).show();$('div#desplegable_'+id).show()}return false}});if ('ut-07-formatted-strings' == 'products') $('div.nav_menu div ul li#menu-item-4180').trigger('click');
</script>
...
<!--    -->
    ...
    <!-- New Ide Note -->
        ...
        <div id="widget-note-orange" class="widget">
            <h3>NEW <a href="/development/waspmote/sdk_applications/">Waspmote Pro API v027</a></h3>
        </div>
        ...
        <a href="#" id="subcategory_sensors-examples"
         ...
         class="subcategory_list"><li>
            ...
            <li id="dev_ag-v30-05-dendrometer-sensor-reading">
                <a href="http://www.libelium.com/development/waspmote/examples/ag-v30-05-dendrometer-sensor-reading/">Ag v30 05: Dendrometer sensor</a>
            </li>
            ...
            <li id="dev_agr-v30-13-ultrasound-sensor">
                <a href="http://www.libelium.com/development/waspmote/examples/agr-v30-13-ultrasound-sensor/">Ag v30 13: Ultrasound sensor</a>
            </li>
            <li id="dev_agr-v30-14-luxes-sensor">
                <a href="http://www.libelium.com/development/waspmote/examples/agr-v30-14-luxes-sensor/">Ag v30 14: Luxes sensor</a>
            </li></ul><li>
        ...
        <a href="#" id="subcategory_communication-examples"
         ...
         class="subcategory_list"><li>
            ...
            <li id="dev_4g-08-send-frames-to-meshlium">
                <a href="http://www.libelium.com/development/waspmote/examples/4g-08-send-frames-to-meshlium/">4G 08: Send frames to Meshlium</a>
            </li>
            ...
            <li id="dev_900hp-04-send-broadcast">
                <a href="http://www.libelium.com/development/waspmote/examples/900hp-04-send-broadcast/">900HP 04a: Send broadcast</a>
            </li>
            ...
            <li id="dev_lorawan-01a-configure-module-eu">
                <a href="http://www.libelium.com/development/waspmote/examples/lorawan-01a-configure-module-eu/">LoRaWAN 01a: Configure module EU</a>
            </li>
            <li id="dev_lorawan-01b-configure-module-us">
                <a href="http://www.libelium.com/development/waspmote/examples/lorawan-01b-configure-module-us/">LoRaWAN 01b: Configure module US</a>
            </li>
            <li id="dev_lorawan-02a-channels-configuration-eu">
                <a href="http://www.libelium.com/development/waspmote/examples/lorawan-02a-channels-configuration-eu/">LoRaWAN 02a: Channels EU</a>
            </li>
            <li id="dev_lorawan-02b-channels-configuration-us">
                <a href="http://www.libelium.com/development/waspmote/examples/lorawan-02b-channels-configuration-us/">LoRaWAN 02b: Channels US</a>
            </li>
            ...
            <li id="dev_wifi-pro-16-send-to-meshlium">
                <a href="http://www.libelium.com/development/waspmote/examples/wifi-pro-16-send-to-meshlium/">WiFi PRO 16: Frame to Meshlium</a>
            </li>
...
<div id="menu_development">
    <ul class="section_list">
        ...
        <li class="first active" id="section_waspmote" style="width: 236px;">
            <a href="/development/waspmote"><img width="56" alt="Waspmote" src="/resources/images/content/development/waspmote_button.png" class="section_img">
                Waspmote</a>
        </li>

        <li class=" " id="section_plug-sense" style="width: 236px;">
            <a href="/development/plug-sense"><img width="56" alt="Plug &amp; Sense!" src="/resources/images/content/development/plug-sense_button.png" class="section_img">
                Plug &amp; Sense!</a>
        </li>

        <li class=" " id="section_meshlium" style="width: 236px;">
            <a href="/development/meshlium"><img width="56" alt="Meshlium" src="/resources/images/content/development/meshlium_button.png" class="section_img">
                Meshlium</a>
        </li>

        <li class="last " id="section_mysignals" style="width: 236px;">
            <a href="/development/mysignals"><img width="56" alt="MySignals" src="/resources/images/content/development/mysignals_button.png" class="section_img">
                MySignals</a>
        </li>
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/ut-07-formatted-strings/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'UT 07: Formatted strings']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> UT 07: Formatted strings</h3>

    <p>This example shows how to use the snprintf function  in order to create formatted strings from variable values. The variables types can be integer types, characters, strings, etc. Conversions are introduced with the character '%'. Possible options can follow the '%':
	%c 	character
	%d 	signed integers
	%i 	signed integers
	%o 	octal
	...
	%u 	unsigned integer
	%x 	unsigned hexadecimal, with lowercase letters
	%X 	unsigned hexadecimal, with uppercase letters </p>
...
UT_07 example - Formatted strings<br />
<br />
1.character: A<br />
2.signed integers: -123<br />
3.string: This_is_a_string<br />
4.unsigned long: 10000000<br />
5.hexadecimal: 41<br />
6.floating point: 123.457<br />
<br />
----------------------------------------<br />
Complete message with several fields:<br />
----------------------------------------<br />
A:A#B:-123#C:This_is_a_string#D:10000000#E:41#F:123.457#<br />
<br />
<br />
</p></div>
    <div class="box seealso"><h4>See also</h4><ul><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide-v12/">Waspmote Technical Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/utilities-guide-v12/">Utilities Guide (v12)</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/waspmote-technical-guide/"> Waspmote Technical Guide</a></li><li><a href="http://www.libelium.com/development/waspmote/documentation/utilities-guide/">Utilities Guide</a></li></ul></div>
    ...
    <div class="box related"><h4>Related examples</h4><ul>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-01-configure-xbee-parameters/">868 01: Configure XBee</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-02-send-packets/">868 02: Send packets</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-03-receive-packets/">868 03: Receive packets</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-04a-send-broadcast/">868 04a: Send broadcast</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-04b-receive-broadcast/">868 04b: Receive broadcast</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-05-get-rssi/">868 05: Get RSSI</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-06a-expansion-board-send/">868 06a: Expansion board TX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-06b-expansion-board-reception/">868 06b: Expansion board RX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-07-set-low-power-mode/">868 07: Set low power mode</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-08a-complete-example-send/">868 08a: Complete example TX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-08b-complete-example-receive/">868 08b: Complete example RX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-09-scan-network/">868 09: Scan network</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-11-send-atcommand/">868 11: Send AT commands</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868-12-setread-power-level/">868 12: Set/Read Power Level</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/868lp-01-configure-xbee-parameters/">868LP 01: Configure XBee</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-01-configure-xbee-parameters/">900 01: Configure XBee</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-02-send-packets/">900 02: Send packets</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-03-receive-packets/">900 03: Receive packets</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-04a-send-broadcast/">900 04a: Send broadcast</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-04b-receive-broadcast/">900 04b: Receive broadcast</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-05-get-rssi/">900 05: Get RSSI</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-06a-expansion-board-send/">900 06a: Expansion board TX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-06b-expansion-board-reception/">900 06b: Expansion board RX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-07-set-low-power-mode/">900 07: Set low power mode</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-08a-complete-example-send/">900 08a: Complete example TX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-08b-complete-example-receive/">900 08b: Complete example RX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-09-scan-network/">900 09: Scan network</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-10-node-search/">900 10: Node search</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-10a-node-search-tx/">900 10a: Node search TX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-10b-node-search-rx/">900 10b: Node search RX</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900-11-send-atcommand/">900 11: Send AT commands</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/900hp-01-configure-xbee-parameters/">900HP 01: Configure XBee</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-1-temperature-sensor-reading/">Ag 01: Temperature Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-2-humidity-sensor-reading/">Ag 02: Humidity Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-3-pressure-sensor-reading/">Ag 03: Atmospheric Pressure</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-4-ldr-sensor-reading/">Ag 04: LDR Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-5-leaf-wetness-sensor-reading/">Ag 05: Leaf Wetness</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-6-digital-temperature-and-humidity-sensor-reading/">Ag 06: Temperature/Humidity (SHT75)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-7-ultraviolet-solar-radiation-sensor-reading/">Ag 07: Ultraviolet Solar Radiation</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-8-photosynthetic-solar-radiation-sensor-reading/">Ag 08: Photosynthetic Solar Radiation</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-9-dendrometer-sensor-reading/">Ag 09: Dendrometer Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-10-pt1000-sensor-reading/">Ag 10: PT1000 Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-11-watermark-sensor-reading/">Ag 11: Watermark Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-12-weather-station-sensor-reading/">Ag 12: Weather Station</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-12b-wind-vane-filtered/">Ag 12b: Wind Vane Filtered</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-13-pluviometer-interruption-reading/">Ag 13: Pluviometer Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-14-reading-ds18b20-temperature/">Ag 14: Reading DS18B20 Temperature</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-15-frame-class-utility/">Ag 15: Frame Class Utility</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ag-v30-01-temperature-sensor-reading/">Ag v30 01: Temperature sensor</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/am-01-temperature-sensor-reading/">AM 01: Temperature Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/am-02-humidity-sensor-reading/">AM 02: Humidity Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/am-03-ldr-senso-reading/">AM 03: LDR Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/am-04-luxes-sensor-reading/">AM 04: Luxes reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/am-05-frame-class-utility/">AM 05: Frame Class Utility</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/am-06-bme-sensor/">AM 06: BME sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ble-01-normal-scan/">BLE 01 Normal scan</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-01-sending-gases-values-via-zigbee/">C 01: Sending gases values via ZigBee</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-02-sending-events-values-via-bluetooth/">C 02: Sending events values via bluetooth</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-03-sending-prototyping-values-via-900/">C 03: Sending prototyping values via 900</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-04-sending-agriculture-values-via-dm900/">C 04: Sending agriculture values via dm900</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-05-sending-agriculture-pro-values-via-digimesh/">C 05: Sending agriculture pro values via Digimesh</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-06-sending-smart-meetering-values-via-wifi-udp/">C 06: Sending smart metering values via wifi udp</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-07-sending-smart-cities-values-via-gprs-udp/">C 07: Sending smart cities values via GPRS UDP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-08-sending-smart-parking-values-via-868/">C 08: Sending smart parking values via 868</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-09-sending-radiation-values-via-gprs-udp/">C 09: Sending radiation values via GPRS udp</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-10-sending-gps-values-via-gprs-http/">C 10: Sending GPS values via GPRS HTTP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-11-sending-gps-values-to-meshlium/">C 11: Sending GPS values to Meshlium</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-12-sending-bluetooth-inquiries-via-wifi-ftp/">C 12: Sending Bluetooth inquiries via WIFI ftp</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-13-sending-bluetooth-inquiries-via-gprs-ftp/">C 13: Sending Bluetooth inquiries via GPRS ftp</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-14-sending-rfid-values-via-802-15-4/">C 14: Sending RFID values via 802.15.4</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-15-sending-basic-values-via-wifi-http/">C 15: Sending basic values via WIFI HTTP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-16-sending-basic-values-via-802-15-4/">C 16: Sending basic values via 802.15.4</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-17-sending-zigbee-data-via-wifi-udp/">C 17: Sending ZigBee data via WIFI UDP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-18-sending-digimesh-values-via-gprs-udp/">C 18: Sending Digimesh values via GPRS UDP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-19-sending-802-15-4-values-via-bluetooth/">C 19: Sending 802.15.4 values via bluetooth</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/c-20-using-gprs-with-hibernate-mode/">C 20: Using GPRS with hibernate mode</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/dm-01-configure-xbee-parameters/">DM 01: Configure XBee</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/dm-09-set-cyclic-sleep-mode/">DM 09: Set cyclic sleep mode</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/dm-10-scan-network/">DM 10: Scan network</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-1-socket-1-reading-with-resistive-sensor/">Ev 01: Socket 1 Resistive Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-2-socket-2-reading-with-resistive-sensor/">Ev 02: Socket 2 Resistive Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-3-socket-3-reading-with-resistive-sensor/">Ev 03: Socket 3 Resistive Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-4-socket-4-for-piezoelectric-sensors-reading/">Ev 04: Socket 4 Piezoelectric</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-5-socket-5-reading-with-temperature-sensor/">Ev 05: Socket 5 Temperature</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-6-socket-6-reading-with-humidity-sensor/">Ev 06: Socket 6 Humidity Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-7-socket-7-reading-with-pir-sensor/">Ev 07: Socket 7 PIR Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-8-socket-8-reading-with-liquid-level-sensor/">Ev 08: Socket 8 Liquid Level</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-9-socket-8-reading-with-flow-sensor/">Ev 09: Socket 8 Flow Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-10-frame-class-utility/">Ev 10: Frame Class Utility</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ev-v30-01-temperature/">Ev v30 01: BME sensor (temperature, humidity &#038; pressure)</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-1-temperature-sensor-reading/">Ga 01: Temperature Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-2-humidity-sensor-reading/">Ga 02: Humidity Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-3-atmospheric-pressure-sensor-reading/">Ga 03: Atmospheric Pressure</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-4-co2-sensor-reading/">Ga 04: CO2 Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-5-o2-sensor-reading/">Ga 05: O2 Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-6-socket2a-sensor-reading/">Ga 06: Socket2A Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-7-socket2b-sensor-reading/">Ga 07: Socket2B Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-8-socket3a-sensor-reading/">Ga 08: Socket3A Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-9-socket3b-sensor-reading/">Ga 09: Socket3B Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-10-socket4-sensor-reading/">Ga 10: Socket4 Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-11-co-sensor-on-socket4-reading/">Ga 11: CO Sensor on Socket4</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-12-nh3-sensor-on-socket3-reading/">Ga 12: NH3 Sensor on Socket3</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-14-o2-calibrated-reading/">Ga 14: O2 calibrated reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-15-frame-class-utility/">Ga 15: Frame Class Utility</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ga-v30-01-bme280-sensor-reading/">Ga v30 01: BME280 sensor</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-01-co/">GP 01: CO</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-02-co2/">GP 02: CO2</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-03-o2/">GP 03: O2</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-04-o3/">GP 04: O3</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-05-no/">GP 05: NO</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-06-no2/">GP 06: NO2</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-07-so2/">GP 07: SO2</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-08-nh3/">GP 08: NH3</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-09-ch4/">GP 09: CH4</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-10-h2/">GP 10: H2</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-11-h2s/">GP 11: H2S</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-12-hcl/">GP 12: HCl</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-13-hcn/">GP 13: HCN</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-14-ph3/">GP 14: PH3</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-15-eto/">GP 15: ETO</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-16-cl2/">GP 16: Cl2</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-17-aqm/">GP 17: AQM</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-18-particle-matter-sensor/">GP 18: Particle Matter Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-19-aqm-with-particle/">GP 19: AQM with particle</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-20-frame-class-utility/">GP 20: Frame Class Utility</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-v30-01-electrochemical-gas-sensors/">GP v30 01 &#8211; Electrochemical gas sensors</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-v30-04-particle-matter-sensor/">GP v30 04 &#8211; Particle Matter Sensor</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gp-v30-05-temperature-humidity-and-pressure-sensor/">GP v30 05 &#8211; Temperature, humidity and pressure sensor</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/gps-05-send-gps-xbeedm/">GPS 05: XBeeDM send</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-01-watchdog-timer-interrupt/">Int 01: Watchdog timer interrupt</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-02-rtc-alarm-interrupt/">Int 02: RTC alarm interrupt</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-03-accelerometer-interrupt/">Int 03: Accelerometer interrupt</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-04-gprs-pro-interrupt/">Int 04: GPRS PRO interrupt</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-05-sensor-event-interrupt/">Int 05a: Sensor Event interrupt</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-05b-agriculture-interrupt/">Int 05b: Agriculture interrupt</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-05-smart-cities-interrupt/">Int 05c: Smart Cities interrupt</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-05d-pir-3g-interrupt/">Int 05d: PIR 3G interrupt</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-06-critical-battery-interrupt/">Int 06: Critical battery interrupt</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/int-08-accelerometer-interrupt-with-no-sleep-mode/">Int 08: Accelerometer interrupt with No Sleep mode</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/documentation/lora-gateway-tutorial-v12/">LoRa Gateway tutorial (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/lorawan-01a-configure-module-eu/">LoRaWAN 01a: Configure module EU</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ota-01-ota-for-xbee-digimesh/">OTA 01: OTA for XBee-DigiMesh</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ota-02-ota-for-xbee-zigbee/">OTA 02: OTA for XBee-ZigBee</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ota-03-ota-for-xbee-802/">OTA 03: OTA for XBee-802.15.4</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ota-04-ota-for-xbee-900/">OTA 04: OTA for XBee-900</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/ota-05-ota-for-xbee-868/">OTA 05: OTA for XBee-868</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/pa-1-smart-parking-test-example/">Pa 01: Smart Parking test example</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/pa-02-frame-class-utility/">Pa 02: Frame Class Utility</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/power-02-deep-sleep-mode/">Power 02: Deep sleep mode</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rb-04-frame-class-v12/">RB 04: Frame Class (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rb-04-frame-class-utility/">RB 04: Frame Class Utility</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-232-03-modbus-slave-acc-battery-v12/">RS-232 03: Modbus Slave ACC &#038; Battery (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-232-04-modbus-master-acc-battery-v12/">RS-232 04: Modbus Master ACC &#038; Battery (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-232-05-modbus-read-coils-v12/">RS-232 05: Modbus Read Coils (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-232-06-modbus-write-single-register-v12/">RS-232 06: Modbus Write Single Register (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-485-04-modbus-read-coils-v12/">RS-485 04: Modbus Read Coils (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-485-05-modbus-read-input-registers-v12/">RS-485 05: Modbus Read Input Registers (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-485-06-modbus-write-single-coil-v12/">RS-485 06: Modbus Write Single Coil (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-485-07-modbus-write-single-register-v12/">RS-485 07: Modbus Write Single Register (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-485-09-modbus-slave-mode-v12/">RS-485 09: Modbus Slave Mode (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-485-10-modbus-slave-acc-battery-level-v12/">RS-485 10: Modbus Slave ACC &#038; Battery Level (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-485-11-modbus-master-acc-battery-level-v12/">RS-485 11: Modbus Master ACC &#038; Battery Level (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rs-485-12-modbus-registers-map-v12/">RS-485 12: Modbus Registers Map (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rsa-01-encryption/">RSA 01: RSA Encryption</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rtc-03-rtc-temperature/">RTC 03: RTC temperature</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rtc-04-alarm-modes/">RTC 04: Alarm modes</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rtc-05-setting-time-from-gps/">RTC 05: Setting time from GPS</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/rtc-06-complete-example/">RTC 06: Complete example</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-1-temperature-sensor-reading/">SC 01: Temperature Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-2-humidity-sensor-reading/">SC 02: Humidity Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-3-ldr-sensor-reading/">SC 03: LDR Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-4-dust-sensor-reading/">SC 04: Dust Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-5-crack-sensor-reading/">SC 05: Crack Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-6-crack-propagation-sensor-reading/">SC 06: Crack Propagation Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-7-crack-detection-sensor-reading/">SC 07: Crack Detection Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-8-ultrasound-sensor-reading/">SC 08: Ultrasound Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-9-audio-sensor-reading/">SC 09: Audio Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-10-reading-ds18b20-temperature/">SC 10: Reading DS18B20 Temperature</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sc-11-frame-class-utility/">SC 11: Frame Class Utility</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/scp-v30-01-electrochemical-gas-sensors/">SCP v30 01 &#8211; Electrochemical gas sensors</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-1-temperature-sensor-reading/">SM 01: Temperature Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-2-humidity-sensor-reading/">SM 02: Humidity Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-3-ldr-sensor-reading/">SM 03: LDR Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-4-current-sensor-reading/">SM 04: Current Sensor Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-5-flow-sensor-on-3v3-socket-reading/">SM 05: Flow Sensor on 3V3 Socket Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-6-flow-sensor-on-5v-socket-reading/">SM 06: Flow Sensor on 5V Socket Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-7-ultrasound-sensor-on-3v3-socket-reading/">SM 07: Ultrasound Sensor on 3V3 Socket Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-8-ultrasound-sensor-on-5v-socket-reading/">SM 08: Ultrasound Sensor on 5V Socket Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-9-linear-displacement-sensor-on-3v3-socket-reading/">SM 09: Linear Displacement Sensor on 3V3 Socket Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-10-linear-displacement-sensor-on-5v-socket-reading/">SM 10: Linear Displacement Sensor on 5V Socket Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-11-5v-load-cell-reading/">SM 11: 5V Load Cell Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-12-10v-load-cell-reading/">SM 12: 10V Load Cell Reading</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-13-reading-ds18b20-temperature/">SM 13: Reading DS18B20 Temperature</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sm-14-frame-class-utility/">SM 14: Frame Class Utility</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sw-08-frame-class-v12/">SW 08: Frame Class (v12)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sw-08-frame-class-utility/">SW 08: Frame Class Utility</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sx-05c-tx-frame-meshlium/">SX 05c: TX Frame Meshlium</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sx-06a-tx-lora-ack-waspframe/">SX 06a: TX Frame ACK</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sx-06c-tx-frame-ack-meshlium/">SX 06c: TX Frame ACK Meshlium</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sx-07a-tx-lora-ackwretries-waspframe/">SX 07a: TX Frame ACK wRetries</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sx-07c-tx-frame-ack-wretries-meshlium/">SX 07c: TX Frame ACK wRetries Meshlium</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/sx-08a-encrypted/">SX 08a: TX encrypted</a>
                    </li>
                    ...
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-01-socket0/">Wifi 01: Switch on (SOCKET0)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-02-socket1/">Wifi 02: Switch on (SOCKET1)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-03-status/">Wifi 03: Display module status</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-04-sleep-auto/">Wifi 04: Sleep mode</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-06-connect-ap-manual/">Wifi 06: Join AP (manual mode)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-08-connect-ap-auto_store/">Wifi 08: Join AP (auto store mode)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-10-ap-not-encrypted/">Wifi 10: Join open AP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-11-ap-wep-encrypted/">Wifi 11: Join WEP encrypted AP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-12-ap-wpa-encrypted/">Wifi 12: Join WPA encrypted AP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-13-ap-wpamix-encrypted/">Wifi 13: Join WPAMIX encrypted</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-14-ap-wpa2-encrypted/">Wifi 14: Join WPA2 encrypted AP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-15-dhcp/">Wifi 15: Using DHCP protocol</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-16-static-ip/">Wifi 16: Using static IP address</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-18-auto-cache-ip/">Wifi 18: Using cached IP address</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-19-broadcast-udp/">Wifi 19: Broadcast UDP messages</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-20a-tcp-client/">Wifi 20a: TCP client</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-20b-tcp-client-frame/">Wifi 20b: TCP client (using Frame)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-21-tcp-server/">Wifi 21: TCP server</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-22-udp-client/">Wifi 22: UDP client</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-23-udp-server/">Wifi 23: UDP server</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-24-ftp-download/">Wifi 24: FTP download</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-25-ftp-upload/">Wifi 25: FTP upload</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-26-http-query/">Wifi 26: HTTP GET</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-26c-sending-frames-to-meshlium/">Wifi 26c: HTTP GET (to Meshlium)</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-27-ping/">Wifi 27: Send a ping</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-28-dns-resolve/">Wifi 28: Resolve a DNS query</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-29a-iphone/">Wifi 29a: iPhone App code</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-29b-android/">Wifi 29b: Android App code</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-30a-pc-app-udp/">Wifi 30a: PC App code &#8211; UDP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-30b-pc-app-tcp/">Wifi 30b: PC App code &#8211; TCP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-30c-pc-app-broadcast-udp/">Wifi 30c: PC App code &#8211; UDP</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-31-set-rtc-from-wifi/">Wifi 31: Set RTC from Wifi</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-32-ota/">Wifi 32: OTA</a>
                    </li>
                    <li>
                      <a href="http://www.libelium.com/development/waspmote/examples/wifi-pro-01-configure-essid/">WiFi PRO 01: Configure ESSID</a>
                    </li>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=UT 07: Formatted strings&p[summary]=This+example+shows+how+to+use+the+snprintf+function++in+order+to+create+formatted+strings+from+variable+values.+The+variables+types+can+be+integer+types%2C+characters%2C+strings%2C+etc.+Conversions+are+introduced+with+the+character+%27%25%27.+Possible+options+can+follow+the+%27%25%27%3A%0D%0A%09%25c+%09character%0D%0A%09%25d+%09signed+integers%0D%0A%09%25i+%09signed+integers%0D%0A%09%25o+%09octal%0D%0A%09%25s+%09a+string+of+characters%0D%0A%09%25u+%09unsigned+integer%0D%0A%09%25x+%09unsigned+hexadecimal%2C+with+lowercase+letters%0D%0A%09%25X+%09unsigned+hexadecimal%2C+with+uppercase+letters+&p[url]=http://www.libelium.com/development/waspmote/examples/ut-07-formatted-strings/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=UT+07%3A+Formatted+strings&url=http://www.libelium.com/development/waspmote/examples/ut-07-formatted-strings/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/ut-07-formatted-strings/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/ut-07-formatted-strings/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
