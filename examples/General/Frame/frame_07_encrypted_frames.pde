...
<title>Frame 07: Encrypted Frames | Libelium</title>
...
<meta name="keywords" content="encryption,frame,waspmote" />
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/frame-07-encrypted-frames/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/frame-07-encrypted-frames/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'Frame 07: Encrypted Frames']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> Frame 07: Encrypted Frames</h3>

    <p>This example shows how to encrypt a Waspmote Frame using the Encryption libraries. In this example AES-128 is used. But AES-192 and AES-256 are available too. Regarding the Block Cipher mode, only ECB is supported. And regarding the padding mode: only ZEROS padding is supported. The result for encryption function is stored in 'frame.buffer' and 'frame.length'</p>
    <div class="box materials"><h4>Required Materials</h4><p>1 x Waspmote<br />
1 x MiniUSB wire<br />
1 x Battery</p></div>
    <div class="box note"><h4>Notes</h4><p>- Regarding the Block Cipher mode, only ECB is supported. <br />
- Regarding the padding mode: only ZEROS padding is supported.<br />
...
new Waspmote Frame created<br />
Battery Level added<br />
RTC temperature added<br />
===============================<br />
Current ASCII Frame:<br />
Length: 47<br />
Frame Type:  128<br />
frame (HEX): 3C3D3E800223333837323634353339236E6F64655F30312330234241543A373823494E5F54454D503A32352E353023<br />
frame (STR): <=>#387264539#node_01#0#BAT:78#IN_TEMP:25.50#<br />
===============================<br />
<br />
2. Encrypting Frame<br />
===============================<br />
Current ENCRYPTED Frame:<br />
Length: 65<br />
Frame Type:  97<br />
frame (HEX): 3C3D3E613C1B3015176E6F64655F30312362E6A8D022275CCDD35ED2E4A04E945025DAAAE1423AA4D89BA92DE9FE808DB1E418251A2B848757F1E2767E227C4907<br />
frame (STR): <=>a<0node_01#bæ¨Ð"'\ÍÓ^Òä NP%ÚªáB:¤Ø©-éþ±ä%+Wñâv~"|I<br />
===============================<br />
...</p></div>
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=Frame 07: Encrypted Frames&p[summary]=This+example+shows+how+to+encrypt+a+Waspmote+Frame+using+the+Encryption+libraries.+In+this+example+AES-128+is+used.+But+AES-192+and+AES-256+are+available+too.+Regarding+the+Block+Cipher+mode%2C+only+ECB+is+supported.+And+regarding+the+padding+mode%3A+only+ZEROS+padding+is+supported.+The+result+for+encryption+function+is+stored+in+%27frame.buffer%27+and+%27frame.length%27&p[url]=http://www.libelium.com/development/waspmote/examples/frame-07-encrypted-frames/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=Frame+07%3A+Encrypted+Frames&url=http://www.libelium.com/development/waspmote/examples/frame-07-encrypted-frames/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/frame-07-encrypted-frames/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/frame-07-encrypted-frames/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
